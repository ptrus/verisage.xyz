...
from src.llm_clients.gemini import GeminiClient  # noqa: E402

# Load environment variables
load_dotenv()


async def test_gemini_prompt(client: GeminiClient, prompt: str):
...
async def main():
    ...
    for prompt in test_prompts:
        try:
            await test_gemini_prompt(client, prompt)
